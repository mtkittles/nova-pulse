...
export const mockStats: StatsResponse = {
  ...
  by_market: [
    { label: "BTTS", tips: 78, win_rate: 0.64, roi: 0.09 },
    { label: "Team O1.5", tips: 71, win_rate: 0.71, roi: 0.07 },
    { label: "Over", tips: 52, win_rate: 0.66, roi: 0.11 },
    { label: "1X2", tips: 40, win_rate: 0.52, roi: 0.14 },
    { label: "Handicap", tips: 21, win_rate: 0.48, roi: 0.05 },
  ],
  by_league: [
    { league: "Premier League", tips: 41, win_rate: 0.68, roi: 0.12 },
    { league: "La Liga", tips: 36, win_rate: 0.64, roi: 0.08 },
    { league: "Bundesliga", tips: 33, win_rate: 0.7, roi: 0.15 },
    { league: "Serie A", tips: 29, win_rate: 0.59, roi: 0.04 },
    { league: "Ligue 1", tips: 24, win_rate: 0.63, roi: 0.07 },
    { league: "Eredivisie", tips: 19, win_rate: 0.74, roi: 0.19 },
  ],
  q_score_buckets: [
    { bucket: "50–60", tips: 38, win_rate: 0.52, roi: -0.03 },
    { bucket: "60–70", tips: 57, win_rate: 0.61, roi: 0.05 },
    { bucket: "70–80", tips: 49, win_rate: 0.68, roi: 0.11 },
    { bucket: "80–90", tips: 28, win_rate: 0.77, roi: 0.18 },
    { bucket: "90–100", tips: 11, win_rate: 0.84, roi: 0.27 },
  ],
}
